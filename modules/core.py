...
def parse_args() -> None:
    ...
    program.add_argument('--swapper-model', help='select face swapper model', dest='swapper_model', default='simswap', choices=['inswapper', 'hififace', 'simswap', 'hyperswap', 'hyperswap-1b'])
    program.add_argument('--live-enhancer', help='face enhancer model for live preview (file processing always uses gfpgan)', dest='live_enhancer_model', default='gpen256', choices=['gpen256', 'gfpgan'])
    ...
    modules.globals.live_enhancer_model = args.live_enhancer_model
    ...
    if modules.globals.max_memory:
        ...
        if platform.system().lower() == 'windows':
            ...
            try:
                ...
                new_soft = min(memory, hard) if hard != resource.RLIM_INFINITY else memory
